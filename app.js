...
function draw(){
  ...
  if(S.screen==="call"){
    var media=S.callVideo?'<video class="fill" src="'+S.callVideo+'" autoplay muted loop playsinline></video>':S.mediaKind==="video"?'<video class="fill" src="'+S.media+'" autoplay muted loop playsinline></video>':S.media?'<img class="fill" src="'+S.media+'" alt="">':face(null,null,S.theirName,"invav");
